...
export const projects: Project[] = [
  {
    ...
    details: {
      summary:
        "Accelerate Gen AI/LLM mastery with guided readings across curated topics. Then drill down with focused topic review and generate practice questions powered by Claude Sonnet 4.5",
  ...
  },
  {
    ...
    details: {
      summary:
        "Interactive DCF valuation model with adjustable segment growth drivers and AI-powered investment analysis. Transforming static spreadsheets into interactive financial intelligence.",
  ...
  {
    title: "Big Tech Investment Co-Pilot",
  ...
  },
  {
    ...
    details: {
      summary:
        "Systematic real-time analysis of 150 earnings calls focusing on tariff impacts, supply chain shifts, and guidance changes during Q1 2025 earnings season",
